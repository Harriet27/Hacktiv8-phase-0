...
function evaluateSlotMachine(Arr) {
  ...
  for (var i = 0; i < 2; i++) {
    ...
    if (inspector === Arr[i + 1] && inspector === Arr[i + 2]) {
      switchCase = "jackpot";
      // console.log(switchCase);
      prize = (Arr[1] + Arr[2] + Arr[0]) * 200;
      totalMoney += prize;
      return ("YOU WIN " + prize + " DOLLARS, YOUR TOTAL CREDIT BALANCE IS " + totalMoney + " DOLLARS");
    } else if (inspector === Arr[i + 1]) {
      switchCase = "semi-jackpot";
      // console.log(switchCase);
      prize = (Arr[1] + Arr[2] + Arr[0]) * 100;
      totalMoney += prize;
      return ("YOU WIN " + prize + " DOLLARS, YOUR TOTAL CREDIT BALANCE IS " + totalMoney + " DOLLARS");
    }
  }
  prize = (Arr[1] + Arr[2] + Arr[0]) * 50;
  totalMoney -= prize;
  return ("YOU LOSE " + prize + " DOLLARS, YOUR TOTAL CREDIT BALANCE IS " + totalMoney + " DOLLARS");
}
